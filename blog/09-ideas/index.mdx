...
It can be just a fancy version control system hub that supports jujutsu natively.
It's raising technology and must be very promising.

### 10: ScyllaDB visualizer

This database shows a lot of promises.
First, many systems proofed it does great job for many use cases where Cassandra and MongoDB can't.
Second, it takes more tracktion as many teams realize how much more expensive DynamoDB becomes at scaling.

This tool is great, but lacks visualization tooling. 
Or may be application layers like analytics store or messaners as a service.
